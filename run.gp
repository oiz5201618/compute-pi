...
plot "result_clock_gettime.csv" using 1:2 title 'baseline' with lines, \
     "result_clock_gettime.csv"	using 1:4 title 'openmp_2' with lines, \
     "result_clock_gettime.csv" using 1:6 title 'openmp_4' with lines
...
plot "result_clock_gettime.csv" using 1:3 title 'baseline' with lines, \
     ...
     "result_clock_gettime.csv" using 1:7 title 'openmp_4' with lines
